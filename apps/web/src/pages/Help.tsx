    ...
    <div className="mx-auto flex w-full max-w-5xl gap-8 p-6">
      ...
      <article className="min-w-0 flex-1 space-y-10 pb-16">
        ...
        <section id="flows" className="scroll-mt-6 space-y-2">
          ...
          <p className="text-sm leading-relaxed text-[var(--text-secondary)]">
            Starter packs on the Flows page add a ready widget. Corporate services covers hours, shipping, returns, tracking, payments, passwords, and plans. Hair studio covers bookings, prices, walk-ins, and the salon address, using the Bella demo menu as the benchmark. A new bot already has the corporate answers. The widget says the words in the published flow. Publish Corporate welcome or Salon welcome in Sandbox when you want to try that greeting. Publish to Production when the live widget should use it.
          </p>
